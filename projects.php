...
<body>
  ...
  <div id="projects-and-clients">
    ...
    <div class="projects-container">
      <div class="project">
        <!-- <div> -->
          <!-- <StyledCoLogo src="" alt="lednet" />
          <StyledCoLogo src="" alt="londonCouncils" /> -->
        <!-- </div> -->
        <h4>
          <span>LEDNet <br /> & <br /> London Councils</span>
        </h4>
        ...
        <div class="description">
          ...
          <!-- <div
            class="personnel-line"
          ></div> -->
        </div>
      </div>
      <div class="project">
        <!-- <div>
          <StyledCoLogo src="" alt="upp" />
        </div> -->
        <h4>
          <span>UPP</span>
        </h4>
      ...
      <div class="project">
        <!-- <div>
          <StyledCoLogo src="" alt="kent" />
          <StyledCoLogo src="" alt="cambridge" />
          <StyledCoLogo src="" alt="surrey" />
        </div> -->
        <h4>
...
<!-- END MODAL -->
      <div class="project">
        <!-- <div>
          <StyledCoLogo src="" alt="isg" />
        </div> -->
        <h4>
          <span>ISG <br /> environmental compliance check</span>
        </h4>
      ...
      <div class="project">
        <!-- <div>
        <StyledCoLogo src="" alt="fisp" />
          <StyledCoLogo src="" alt="fsc" />
          <StyledCoLogo src="" alt="atmosphere" />
  ...
  help ensure that the learning aims and outcomes were achieved.
      ...
      <div class="project">
        <!-- <div>
          <StyledCoLogo src="" alt="ciriaLearn" /> -->
        <!-- </div> -->
        <h4>
